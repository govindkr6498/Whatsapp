    ...
    def process(self, message: str) -> Dict[str, Any]:
        ...
        if "Sorry, I can only answer questions" not in rag_response:
            ...
            system_prompt = (
                ...
                "respond warmly and conversationally, and guide them to ask about ServiceZone UAE,location,,working culture,Working style, meetings, or services. or ServiceZone "
                "If the user's question is not related to ServiceZone UAE or ServiceZone, politely respond: 'Sorry, I can only answer questions related to ServiceZone UAE, meetings, or our services. Please ask something related.' "
